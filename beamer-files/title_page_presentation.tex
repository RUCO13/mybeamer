...
at (current page.north west) {\includegraphics{../beamer-figures/title-page/logo_iico_azul.png}};
...
at (current page.north east) {\includegraphics{../beamer-figures/title-page/logo_uaslp_azul.png}};      
